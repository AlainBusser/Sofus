traduction = (dutexte) ->
  ...
  texte = texte.replace /Mettre dans\ /g, "mettreDans "
#  texte = texte.replace /mettre ([^\ ])\ +dans\ +([^\])/g, "mettre $1, dans, $2"
#  texte = texte.replace /Mettre ([^\ ])\ +dans\ +([^\])/g, "mettre $1, dans, $2"
...
#  texte = texte.replace /si\ /g, "if "
  ...
  texte = texte.replace /\ +à la puissance/g, ", aLaPuissance,"
  texte = texte.replace /extraire la racine de/g, "extraireLaRacineDe "
