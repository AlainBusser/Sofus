...
Blockly.JavaScript['avancer'] = function(block) {
  ...
  return code = 'window.totos[window.toto].av(' + value_name + ');\n';
};

Blockly.JavaScript['reculer'] = function(block) {
  var code, value_name;
  value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);
  return code = 'window.totos[window.toto].re(' + value_name + ');\n';
};

Blockly.JavaScript['tortue_gauche'] = function(block) {
  var angle_name, code;
  angle_name = block.getFieldValue('NAME');
  return code = 'window.totos[window.toto].tg(' + angle_name + ');\n';
};

Blockly.JavaScript['tortue_droite'] = function(block) {
  var angle_name, code;
  angle_name = block.getFieldValue('NAME');
  return code = 'window.totos[window.toto].td(' + angle_name + ');\n';
};
...
Blockly.JavaScript['var_gauche'] = function(block) {
  ...
  return code = 'window.totos[window.toto].tg(' + value_angle + ');\n';
};

Blockly.JavaScript['var_droite'] = function(block) {
  var code, value_angle;
  value_angle = Blockly.JavaScript.valueToCode(block, 'ANGLE', Blockly.JavaScript.ORDER_ATOMIC);
  return code = 'window.totos[window.toto].td(' + value_angle + ');\n';
};

Blockly.JavaScript['mettre_angle'] = function(block) {
  var code, value_angle;
  value_angle = Blockly.JavaScript.valueToCode(block, 'ANGLE', Blockly.JavaScript.ORDER_ATOMIC);
  return code = 'window.totos[window.toto].orient(' + value_angle + ');\n';
};
...
Blockly.JavaScript['teleport'] = function(block) {
  ...
  return code = 'window.totos[window.toto].teleport(' + text_x + '+320,240-(' + text_y + '));\n';
};
...
Blockly.JavaScript['teleport_var'] = function(block) {
  ...
  return code = 'window.totos[window.toto].teleport(' + variable_x + '+320' + ',240-(' + variable_y + '));\n';
};

Blockly.JavaScript['lever_stylo'] = function(block) {
  var code;
  return code = 'window.totos[window.toto].penup();\n';
};

Blockly.JavaScript['baisser_stylo'] = function(block) {
  var code;
  return code = 'window.totos[window.toto].pendown();\n';
};
...
Blockly.JavaScript['reset'] = function(block) {
  var code;
  return code = 'effaceDessin();' + 'window.totos[window.toto].t = 0;' + 'window.totos[window.toto].teleport(320,240);\n';
};
...
Blockly.JavaScript['creer_tortue'] = function(block) {
  ...
  return code = "window.totos['" + text_n + "'] = new Tortue();\nconsole.log(window.totos);\n";
};
