...
Blockly.Blocks['constante_entier'] = {
  init: function() {
    ...
    this.setOutput(true, "Fraction");
    this.setColour(45);
    this.setTooltip('whole number as fraction');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['egale'] = {
  init: function() {
    ...
    this.setColour(45);
    this.setTooltip('equality between fractions');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['inferieure'] = {
  init: function() {
    ...
    this.setOutput(true, "Boolean");
    this.setColour(45);
    this.setTooltip('inequality between fractions');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['frac_plus'] = {
  init: function() {
    ...
    this.setOutput(true, "Fraction");
    this.setColour(45);
    this.setTooltip('addition of fractions');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['frac_moins'] = {
  init: function() {
    ...
    this.setOutput(true, "Fraction");
    this.setColour(45);
    this.setTooltip('subtraction of fractions');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['frac_fois'] = {
  init: function() {
    ...
    this.setOutput(true, "Fraction");
    this.setColour(45);
    this.setTooltip('multiplication of fractions');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['frac_sur'] = {
  init: function() {
    ...
    this.setOutput(true, "Fraction");
    this.setColour(45);
    this.setTooltip('division of fractions');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['fraction_build'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("build a fraction with");
    ...
    this.setOutput(true, "Fraction");
    this.setColour(45);
    this.setTooltip('define a fraction');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['egyptian'] = {
  init: function() {
    ...
    this.setColour(45);
    this.setTooltip('egyptian fractions');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['numerateur'] = {
  init: function() {
    this.appendValueInput("FRAC")
        .setCheck("Fraction")
        .appendField("numerator of");
    this.setOutput(true);
    this.setColour(45);
    this.setTooltip('the whole number which will be divided');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['denominateur'] = {
  init: function() {
    this.appendValueInput("FRAC")
        .setCheck("Fraction")
        .appendField("denominator of");
    this.setOutput(true);
    this.setColour(45);
    this.setTooltip('the number by which the numerator will be divided');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['arrondi'] = {
  init: function() {
    this.appendValueInput("FRAC")
        .setCheck("Fraction")
        .appendField("approximate value of");
    this.setOutput(true);
    this.setColour(45);
    this.setTooltip('the quotient');
    this.setHelpUrl('');
  }
};
