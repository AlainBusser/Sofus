...
Blockly.Blocks['fraction_build'] = {
  init: function() {
    ...
    this.setOutput(true, "Fraction");
    this.setColour(45);
    this.setTooltip('definir una fracción');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['egyptian'] = {
  init: function() {
    ...
    this.setColour(45);
    this.setTooltip('fracciones egipcias');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['numerateur'] = {
  init: function() {
    this.appendValueInput("FRAC")
        .setCheck("Fraction")
        .appendField("numerador de");
    this.setOutput(true);
    this.setColour(45);
    this.setTooltip('el número que se divide');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks['denominateur'] = {
  init: function() {
    this.appendValueInput("FRAC")
        .setCheck("Fraction")
        .appendField("denominador de");
    this.setOutput(true);
    this.setColour(45);
    this.setTooltip('el número por el que el numerador se divide');
    this.setHelpUrl('');
  }
};
