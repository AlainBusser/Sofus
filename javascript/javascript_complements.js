...
Blockly.JavaScript['decimal_comp'] = function(block) {
  var code, dropdown_type, value_nb1, value_nb2;
  ...
  switch (dropdown_type) {
    case 'EQ':
      code = 'Math.abs(' + value_nb2 + '-' + value_nb1 + ')<1e-10';
      break;
    case 'LT':
      code = value_nb2 + '-' + value_nb1 + '>1e-10';
      break;
    case 'GT':
      code = value_nb1 + '-' + value_nb2 + '>1e-10';
      break;
    case 'NEQ':
      code = 'Math.abs(' + value_nb2 + '-' + value_nb1 + ')>1e-10';
      break;
