...
Blockly.Blocks['decimal_comp'] = {
  init: function() {
    this.appendValueInput('NB1').setCheck('Number');
    this.appendDummyInput().appendField(new Blockly.FieldDropdown([['=', 'EQ'], ['<', 'LT'], ['>', 'GT'], ['≠', 'NEQ'], ['≤', 'LE'], ['≥', 'GE']]), 'type');
    this.appendValueInput('NB2').setCheck('Number');
    this.setInputsInline(true);
    this.setOutput(true, 'Boolean');
    this.setColour(230);
    this.setTooltip('égalité des nombres');
  }
};
...
Blockly.Blocks['costume'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage('img/turtle.png', 32, 32, '')).appendField('choisir l\'avatar').appendField(new Blockly.FieldDropdown([["origine", "0"], ["coccinelle", "1"], ["gauche", "2"], ["droit", "3"], ["Frenet", "4"], ["métal", "5"], ["classique", "6"]]), "CID");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setColour(120);
    this.setTooltip('changer l\'aspect de la tortue');
