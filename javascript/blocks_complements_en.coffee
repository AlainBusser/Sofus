...
Blockly.Blocks['costume'] = init: ->
  @appendDummyInput().appendField(new (Blockly.FieldImage)('img/turtle.png', 32, 32, '')).appendField('choose avatar').appendField(new Blockly.FieldDropdown([["origine", "0"], ["gauche", "1"], ["droit", "2"], ["Frenet", "3"], ["métal", "4"], ["classique", "5"]]), "CID")
  @setPreviousStatement true
  @setNextStatement true
  @setColour 120
  @setTooltip 'change the look of the turtle'
